...
import EditDashbordSidebar from "../../components/edit/editDashbordSidebar";
import { Box, Grid, Paper, styled } from "@mui/material";
import DashboardCharts from "../../components/edit/dashbord-chartComponent";
import InputFields from "../../components/edit/InputFields";
import DashboardFilter from '../../components/dashbord-Elements/dashboardFilter';
import Filters from '../../components/edit/tableFilter';
import HomePage from '../HomePage';
...
function EditDashboard() {
  ...
  return (
    <div className="App">
      <Grid container spacing={2} style={{ marginTop: '60px', minHeight: '92vh' }}>
        <HomePage />
