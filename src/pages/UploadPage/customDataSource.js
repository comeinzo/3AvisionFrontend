  ...
  const handleConfirmJoin = async () => {
    ...
    if (!droppedTables[0]?.joinKey || !droppedTables[1]?.joinKey) {
      // alert('Select join keys for both tables.');
       setDialogTitle("Warning");
            setDialogMessage('Select join keys for both tables.');
            setDialogType("INFO");
            setDialogOpen(true);
      return;
    }
    if (!joinTableName) {
      // alert('Enter a name for the joined table.');
       setDialogTitle("Warning");
            setDialogMessage('Enter a name for the joined table.');
            setDialogType("INFO");
            setDialogOpen(true);
      return;
    }
    if (Object.keys(selectedColumns).length === 0) {
      // alert('Select columns for the joined table.');
            setDialogTitle("Warning");
            setDialogMessage('Select columns for the joined table.');
            setDialogType("INFO");
            setDialogOpen(true);
      return;
    }
    ...
    setDialogMessage("Join operation completed successfully.");
    ...
    setDialogMessage("Error performing join operation.");
    setDialogType("error");
    setDialogOpen(true);
    }
  };
