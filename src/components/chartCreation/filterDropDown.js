...
// //     setLocalSelectAllChecked(false);
// // };
...
// //                     <Button variant="outlined" onClick={handleClear} sx={{ mx: 1, flex: 1 }}>Clear</Button>
...
// import { setCheckedOptionsForColumn, setSelectAllCheckedForColumn } from '../../features/Dashboard-Slice/chartSlice';
// import {
//     Modal, Box, Typography, List, ListItemButton, ListItemIcon,
//     Checkbox, Button, Divider, Stack
// } from '@mui/material';
// import { FixedSizeList as VirtualizedList } from 'react-window';
...
//     const handleCheckboxChange = (option) => {
//         const updatedOptions = localCheckedOptions.includes(option)
//             ? localCheckedOptions.filter(item => item !== option)
//             : [...localCheckedOptions, option];
...
//                 overflow: 'auto',
//             }}>
//                 <Typography id="filter-modal-title" variant="h6" align="center" mb={2}>
//                     Filter Options for <strong>{column}</strong>
//                 </Typography>
...
//                     p: 0
//                 }}>
//                     <ListItemButton onClick={handleSelectAllChange} sx={{ minHeight: 40 }}>
...
import {
    Modal, Box, Typography, List, ListItemButton, ListItemIcon,
    Checkbox, Button, Divider, Grid, useTheme, Tooltip
} from '@mui/material';
import { FixedSizeList as VirtualizedList } from 'react-window';
import { setCheckedOptionsForColumn, setSelectAllCheckedForColumn } from '../../features/Dashboard-Slice/chartSlice';
        ...
        <Modal open={open} onClose={handleClose} aria-labelledby="filter-modal-title">
            ...
            >
                <Typography
                    ...
                    fontWeight={600}
                >
                    Filter: <span style={{ color: theme.palette.primary.main }}>{column}</span>
                </Typography>

                <Box sx={{ border: '1px solid #ddd', borderRadius: 2, overflow: 'hidden' }}>
                    <List disablePadding>
                        <ListItemButton onClick={handleSelectAllChange} sx={{ minHeight: 44 }}>
                            <ListItemIcon>
                                <Checkbox
                                    checked={localSelectAllChecked}
                                    edge="start"
