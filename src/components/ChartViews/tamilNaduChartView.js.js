...
useEffect(() => {
    ...
    const handleLegendClick = (category) => {
        setLegendColors(prevColors => ({
            ...prevColors,
            [category]: prevColors[category] === 'grey' ? districtColors[category] : 'grey',
        }));
    };
                                     ...
                                     const district = geo.properties.NAME_2 || "Unknown";
                                                      ...
                                                      return (
                                                        <React.Fragment key={geo.rsmKey}>
                                                          <Geography
                                                            geography={geo}
                                            onMouseEnter={() => setTooltipContent(`${district}: ${value}`)}
