  ...
  return (
    ...
    >
      ...
      {children.length === 0 && imagePositions.length === 0 && ( // Only show if no charts or images
        ...
        <Typography variant="body1"> Drag and drop chart name to view its visualization here.</Typography>
         <Typography variant="body1">Click on the "Add Image" icon at the top to add a picture.</Typography>
