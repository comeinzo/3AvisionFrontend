...
useEffect(() => {
  ...
  else if (xLen > 2 && yLen === 1 && chartType !== 'hierarchialBarChart'&& chartType !== 'treeHierarchy'&& chartType !== 'hierarchialBarChart'&& chartType !== 'treeHierarchy' &&  chartType !== 'stackedbar') {
    dispatch(setChartType('hierarchialBarChart'));
    sessionStorage.setItem('selectedChartType', 'hierarchialBarChart');
  }
  // else if (xLen === 1 && yLen === 1 && chartType !=='bar' && chartType !== 'pie' && chartType !== 'Donut' && chartType !== 'scatter' && chartType !== 'line' && chartType !== 'area' && chartType !== 'polarArea' && chartType !== 'mapchart' && chartType !== 'TamiNadu_Map_Chart' && chartType !== 'India_Map_Chart' && chartType !== 'animatedTreeChart' && chartType !== 'wordCloud' && chartType !== 'bubbleChart') {
  //   dispatch(setChartType('bar'));
  //   sessionStorage.setItem('selectedChartType', 'bar');
  // }
  // else if (xLen === 1 && yLen === 0 && chartType !== 'singleValueChart') {
  //   dispatch(setChartType('singleValueChart'));
  //   sessionStorage.setItem('selectedChartType', 'singleValueChart');
  // }
...
//   // Only execute on /Edit_Chart route
...
//       xLen >= 2 &&
//       yLen === 1 &&
//       chartType !== 'duealbarChart' &&
//       chartType !== 'tablechart' &&
//       chartType !== 'hierarchialBarChart' &&
...
//     }
//   }
// }, [xAxis, yAxis, chartType, dispatch, location.pathname]);
